                ...
                <tr>
                    <td class="idrow"><?php echo $producto->id_producto;  ?></td>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-success btn_elim" style="margin-left: 4px; width: 45px; height: 50px; padding-top: 4px; margin-top: 30px" href="<?php echo base_url("activar_producto/$producto->id_producto");?>">
