      ...
      <div class="container_user">
        ...
        <div class="all-filters_user">
          ...
          <div class="formulario_user">
              <form action="<?php echo base_url('buscaruserelim'); ?>" method="GET" style="">
      ...
      <tbody class="container-user">
        <?php foreach($usuarios->result() as $user){ ?>
          <tr>
            ...
            <td>
              <a type="button" class="btn btn-success" href="<?php echo base_url("usuarios_activ/$user->id");?>"><i class="fas fa-check" style=" margin-left: -10%; padding-right: 6px;"></i> 
                Activar
              </a>
            </td>
          </tr>
