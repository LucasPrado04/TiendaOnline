<?php if (!$productos) { ?>
   ...
   <div class="containers">
      <div class="well-gancia">
         <h1>FERNET</h1>
      </div>	
      <div class="all-filters">
            <div class="nav-gancia" style="margin-left: 40px">
               <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                     ...
                     <li><a class="dropdown-item" href="<?php echo base_url('mostrarfernet');?>">Vodka</a></li>
            ...
            <div class="ex-wine" style="margin-right: 40px">
