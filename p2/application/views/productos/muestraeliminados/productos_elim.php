      ...
      <?php if( ($this->session->userdata('logged_in')) and ($perfil_id == '1') ) { ?>
            <div class="all-filters">
               ...
               <div class="formulariz">
                  <form action="<?php echo base_url('buscar_elim'); ?>" method="GET">
...
<?php } else { ?>
   <div class="containers">
         ...
         <div class="all-filters">
            ...
            <div class="formulariz">
               <form action="<?php echo base_url('buscar_eliminados'); ?>" method="GET">
                  <input class="busqueda_s" style="width: 80%; height: 37px;" type="search" placeholder="Buscar producto eliminado" name="query">
                  <button class="btn btn-outline-info">Buscar</button>
               </form>
            </div>
            <div class="ex-but">
            ...
            <?php foreach($productos->result() as $row){ 
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a type="button" class="btn btn-success btn_elim" style="margin-left: 4px; width: 45px; height: 50px; padding-top: 4px; margin-top: 30px" href="<?php echo base_url("activar_producto/$row->id_producto");?>">
